...
macro(_set_flags)
  set(MSVC_WARNINGS
      ...
      /w14062 # enumerator 'identifier' in a switch of enum 'enumeration' is not
              # handled
...
function(set_warnings)
  ...
  message(
    STATUS "  Treat warnings as errors: ${${projectPrefix}WARNINGS_AS_ERRORS}")
...
function(set_target_warnings target scope)
  ...
  if(NOT scope IN_LIST scopes)
    message(
      FATAL_ERROR
        "'scope' argument should be one of ${scopes} ('${scope}' received)")
  endif()

  _set_flags()

  message(
    STATUS "Setting ${scope} restrictive compilation warnings for '${target}'")
  message(
    STATUS "  Treat warnings as errors: ${${projectPrefix}WARNINGS_AS_ERRORS}")
  message(STATUS "  Flags: ${flags}")
  message(
    STATUS
      "Setting ${scope} restrictive compilation warnings for '${target}' - done"
  )
